...
void Systema::agregarHuesped(std::string nombre, std::string email, bool esFinger) {
    for (auto huesped : huespedes) {
...
void Systema::agregarHabitacion(int numero, float precio, int capacidad) {
    for (auto habitacion : habitaciones) {
...
DTHuesped** Systema::obtenerHuespedes(int& cantHuespedes) {
...
DTHabitacion** Systema::obtenerHabitaciones(int& cantHabitaciones) {
...
void Systema::registrarReserva(std::string email, DTReserva* reserva) {
...
DTReserva** Systema::obtenerReservas(DTFecha fecha, int& cantReservas) {
